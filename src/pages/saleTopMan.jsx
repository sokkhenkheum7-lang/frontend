...
import { categories, saleProducts, extraSaleProducts } from "../Data/saleTopsMan";

export default function SaleTops({ initialCategory = "SALE TOPS", onBackToHome }) {
  ...
  useEffect(() => {
    if (initialCategory) {
      // Normalize to uppercase to match categories array
  ...
  // Case-insensitive filtering supporting "ALL"
